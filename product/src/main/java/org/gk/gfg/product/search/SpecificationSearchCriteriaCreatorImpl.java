...
public class SpecificationSearchCriteriaCreatorImpl implements SpecificationSearchCriteriaCreator {
  private static Pattern commaSeparatedNumericRegex =
      Pattern.compile("^[\\d|\\.]+(?:[ \\t]*,[ \\t]*[\\d|\\.]+)+$");
  ...
  private Object prepareSpecificatoinSearchCriteria(final String key, final Class<?> type,
      final SearchOperators op, final String value) {
