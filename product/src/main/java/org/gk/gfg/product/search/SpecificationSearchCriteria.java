...
public class SpecificationSearchCriteria {
  ...
  public SpecificationSearchCriteria(final String key, final SearchOperators operation,
      final Object value) {
    super();
    this.key = key;
  ...
  public SpecificationSearchCriteria(final String orPredicate, final String key,
      final SearchOperators operation, final Object value) {
    super();
    this.key = key;
    this.operation = operation;
    this.value = value;
  ...
  public SpecificationSearchCriteria(final String key, final String operation, final String prefix,
    ...
    if (op != null) {
      if (op == SearchOperators.EQUAL) {
        final boolean startWithAsterisk =
            prefix != null && prefix.contains(SearchOperators.ZERO_OR_MORE_REGEX);
        final boolean endWithAsterisk =
            suffix != null && suffix.contains(SearchOperators.ZERO_OR_MORE_REGEX);
